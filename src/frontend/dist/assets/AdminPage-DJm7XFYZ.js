import { r as reactExports, j as jsxRuntimeExports, R as React, a as reactDomExports, v as vt, o } from "./index-DEhLQzcn.js";
import { u as useActor } from "./useActor-B-vCTMEe.js";
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = o.useMemo(() => t.duration || X2 || Wt, [t.duration, X2]), gt = o.useRef(0), U = o.useRef(0), St = o.useRef(0), K = o.useRef(null), [Gt, Qt] = st.split("-"), Rt = o.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
...
const FASHION_KEYS = /* @__PURE__ */ new Set([
  "sarees",
  "kurtaKurtis",
  "festive",
  "gowns",
...
function buildCategory(value) {
  if (FASHION_KEYS.has(value))
    return { __kind__: "fashion", fashion: value };
  return { __kind__: "jewellery", jewellery: value };
}
function getCategoryKey(cat) {
  if (cat.__kind__ === "fashion") return cat.fashion;
...
function AdminPage({ navigate }) {
  ...
  reactExports.useEffect(() => {
    ...
    actor.validateAdminToken(stored).then((valid) => {
  ...
  const handleLoginSuccess = reactExports.useCallback((t) => {
  ...
  if (isFetching || authLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen admin-bg flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-gold-500" }) });
  }
  if (isActorError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen admin-bg flex flex-col items-center justify-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-admin-text font-semibold", children: "Connection failed. The server may be waking up." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function LoginScreen({ actor, onSuccess, navigate }) {
    ...
    try {
      ...
      for (let attempt = 0; attempt < 3; attempt++) {
        try {
          ...
          lastError = err;
          if (attempt < 2) await new Promise((r2) => setTimeout(r2, 1e3));
        }
      }
      if (lastError) throw lastError;
      const token = Array.isArray(result) ? result.length > 0 ? result[0] : null : result;
      if (!token) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen admin-bg flex flex-col items-center justify-center p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gold-500/10 border border-gold-500/30 mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-8 w-8 text-gold-500" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-admin-text tracking-tight", children: "Admin Panel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-admin-muted mt-1", children: "RecomNow India — Secure Login" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "admin-card rounded-2xl p-8 shadow-2xl border border-admin-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-admin-muted mt-6", children: [
        "© ",
...
function Dashboard({ actor, token, onLogout, navigate }) {
  ...
  const [deletePending, setDeletePending] = reactExports.useState(false);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      ue.success(`"${deleteTarget.title}" deleted successfully.`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen admin-bg flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 admin-header border-b border-admin-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-lg bg-gold-500/10 border border-gold-500/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-4 w-4 text-gold-500" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-admin-text text-lg tracking-tight", children: "RecomNow Admin" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold text-admin-text", children: "Product Management" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-admin-muted mt-0.5", children: "Manage your product catalogue" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "admin-card border-admin-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-xs font-medium text-admin-muted uppercase tracking-wider flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-3.5 w-3.5" }),
            "Total Products"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-admin-text", children: totalProducts }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "admin-card border-admin-border", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-xs font-medium text-admin-muted uppercase tracking-wider flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-gold-500", children: featuredCount }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "admin-card rounded-xl border border-admin-border overflow-hidden", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "data-ocid": "admin.products.loading_state",
          className: "flex items-center justify-center py-20",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-6 w-6 animate-spin text-gold-500" })
        }
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "h-10 w-10 text-admin-muted mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-admin-text font-medium", children: "No products yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-admin-muted text-sm mt-1", children: 'Click "Add New Product" to get started.' })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "admin.products.table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "admin-table-header border-admin-border hover:bg-transparent", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider w-16", children: "ID" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider min-w-[180px]", children: "Title" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider hidden md:table-cell", children: "Category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider text-right", children: "Price (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider text-right hidden sm:table-cell", children: "MRP (₹)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider text-right hidden lg:table-cell", children: "Disc%" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider text-center hidden md:table-cell", children: "Featured" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-admin-muted font-semibold text-xs uppercase tracking-wider text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: products.map((product, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TableRow,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-admin-muted text-xs font-mono", children: String(product.id) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-admin-text text-sm font-medium line-clamp-1", children: product.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-admin-muted text-xs line-clamp-1 mt-0.5 hidden sm:block", children: product.description })
              ] }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right text-admin-text text-sm font-semibold", children: [
                "₹",
                Math.round(Number(product.price) / 100).toLocaleString(
                  "en-IN"
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "text-right text-admin-muted text-sm hidden sm:table-cell", children: [
                "₹",
                Math.round(Number(product.mrp) / 100).toLocaleString(
                  "en-IN"
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right hidden lg:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-400 text-sm font-medium", children: [
                String(product.discountPercentage),
                "%"
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-center hidden md:table-cell", children: product.isFeatured ? /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-4 w-4 text-gold-500 inline-block" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-admin-muted text-xs", children: "—" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-admin-border py-5 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-admin-muted", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      ". Built with love using",
      " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: deleteDialogOpen, onOpenChange: setDeleteDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        "data-ocid": "delete.dialog",
        className: "admin-dialog border-admin-border max-w-md",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-admin-text", children: "Delete Product" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-admin-muted text-sm", children: [
            "Are you sure you want to delete",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-admin-text font-semibold", children: [
              '"',
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: deletePending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "mr-2 h-4 w-4 animate-spin" }),
                  "Deleting…"
                ] }) : "Delete"
              }
...
function ProductFormDialog({
  ...
  const validate = () => {
    ...
    if (form.discountPercentage === "" || Number.isNaN(Number(form.discountPercentage)) || Number(form.discountPercentage) < 0 || Number(form.discountPercentage) > 100)
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-blue-800 text-lg font-bold", children: editProduct ? "Edit Product" : "Add New Product" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "mt-2 flex flex-col gap-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Title", error: errors.title, required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: form.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Description", error: errors.description, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Image URL", error: errors.imageUrl, required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: form.imageUrl,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Price (₹)", error: errors.price, required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: form.price,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "MRP (₹)", error: errors.mrp, required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: form.mrp,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FormField, { label: "Category", required: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: form.categoryKey,
              onValueChange: (val) => setForm((prev) => ({ ...prev, categoryKey: val })),
              disabled: saving,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "bg-white border border-blue-200 text-blue-800", children: CATEGORY_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectItem,
                  {
                    value: opt.value,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between rounded-lg border border-blue-200 bg-blue-50/50 px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-blue-800", children: "Featured Product" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-blue-700", children: "Show on home page highlights" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
...
function FormField({ label, error, required, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-blue-700 text-sm font-semibold", children: [
      label,
      required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-500 ml-0.5", children: "*" })
    ] }),
    children,
